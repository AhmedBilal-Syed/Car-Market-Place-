...
const blogPosts = [
  ...
  {
    title: "JAC T9 Hunter Makes History with 24-Hour Speed Endurance Record in South Africa",
    image: "https://picsum.photos/id/1/200/200",
  ...
  {
    title: "Hyundai Santa Fe Signature vs. Kia Sorento 1.6 FWD | D-SUVs from Korea",
    image: "https://picsum.photos/id/1/200/200",
...
const newsPosts = [
  {
    id: 1,
    title: "Alto's EV Competitor Inverex Xio Is Here – Price & Specs",
    image: "https://images.pexels.com/photos/358070/pexels-photo-358070.jpeg", // Replace with real image URL
    category: "News",
    author: "Sulman Ali",
    date: "May 16, 2025",
    excerpt: "Pakistan’s electric vehicle scene just got a little more exciting.",
  },
  {
    id: 2,
    title: "All New Cars Coming To Pakistan – Shanghai AutoShow 2025",
    image: "https://images.pexels.com/photos/210019/pexels-photo-210019.jpeg", // Replace with real image URL
    category: "Auto Events",
    author: "Sulman Ali",
    date: "April 29, 2025",
    excerpt: "Massive lineup of futuristic models was showcased at the Shanghai AutoShow 2025.",
  },
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-2/3">
          ...
          {blogPosts.map((post, index) => (
            <div key={index} className="flex flex-col md:flex-row gap-4 mb-8 border-b pb-4">
              <div className="relative top-6">
                ...
                />
                <span className="absolute bottom-4 left-1 text-xs text-white bg-red-700 px-2 py-1  uppercase">
                  {post.category}
                </span>
              </div>
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-700 space-y-2">{post.excerpt}</p>
              </div>
            </div>
          ))}
          ...
          <div className="mt-10">
            ...
            <div className=" grid grid-cols-2 gap-5 ">
              {newsPosts.map((news) => (
                <div key={news.id} className="flex flex-col gap-4 border-b pb-4">
                  <img
                    src={news.image}
                    alt={news.title}
                  ...
                  <div>
                    <span className="text-xs text-white bg-red-700 px-2 py-1 rounded uppercase inline-block mb-1">
                      {news.category}
                    </span>
                    <span className="font-semibold text-gray-900 hover:text-blue-600 cursor-pointer">
                      {news.title}
...
<div className="mt-8 border p-4 rounded-md shadow-sm">
  ...
  <div className="flex flex-wrap gap-2 text-sm">
    {[
      "10th Generation Honda Civic", "2016 Honda Civic", "Atlas Honda", "Audi",
      "BMW", "cars", "Car Sales", "Cars in Pakistan", "Civic", "Corolla",
      "Honda", "Honda Atlas", "Honda City", "honda civic", "Hybrid", "Hyundai",
      "imported cars", "indus motors", "Kia Sportage", "lamborghini",
      "Mercedes", "Nissan", "Pakistan", "Pak Suzuki", "pakWheels", "PAMA",
      "petrol", "Petrol Price", "Petrol Price in Pakistan", "petrol prices",
      "Suzuki", "Suzuki Alto", "Suzuki Mehran", "Suzuki Swift", "Tesla",
      "Toyota", "Toyota Corolla", "Toyota Pakistan", "Toyota Prius",
      "Toyota yaris", "used cars", "Yamaha", "گاڑیاں", "کار", "موٹر سائیکل"
    ].map((tag, index) => (
      <span
        key={index}
...
<div className="mt-10">
  <h2 className="text-lg font-bold mb-4 border-b pb-2 hover:text-red-700">Tips & Advice</h2>
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
    {tipsPosts.slice(0, 8).map((post) => (
      <div key={post.id} className="bg-white shadow-sm rounded overflow-hidden">
...
<div className="mt-10">
  <h2 className="text-lg font-bold mb-4 border-b pb-2 hover:text-red-700">OPINIONS</h2>
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
...
<div className="mt-12 space-y-8 text-sm text-gray-700">
  <div>
    <h3 className="font-semibold text-base mb-2">Popular Cars</h3>
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-y-1">
      {[
        "Toyota Corolla", "Honda Civic", "Honda City", "Suzuki Mehran", "Suzuki WagonR", "Suzuki Cultus", "Daihatsu Mira", "Daihatsu Move",
        "Suzuki Alto", "Toyota Vitz", "Toyota Aqua", "Toyota Prado", "Honda Vezel", "Honda N Wgn", "Honda Fit", "Daihatsu Cuore"
      ].map((car, idx) => (
        <a key={idx} href="#" className="text-blue-600 hover:underline">{car}</a>
      ))}
    </div>
  </div>

  <div>
    <h3 className="font-semibold text-base mb-2">Browse Cars by City</h3>
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-y-1">
      {[
        "Cars Lahore", "Cars Karachi", "Cars Islamabad", "Cars Rawalpindi", "Cars Peshawar", "Cars Faisalabad", "Cars Multan", "Cars Gujranwala",
        "Cars Bahawalpur", "Cars Sialkot", "Cars Abbottabad", "Cars Sargodha", "Cars Mardan", "Cars Wah cantt", "Cars Hyderabad", "Cars Gujrat"
      ].map((city, idx) => (
        <a key={idx} href="#" className="text-blue-600 hover:underline">{city}</a>
      ))}
    </div>
  </div>

  <div>
    <h3 className="font-semibold text-base mb-2">Popular Bikes</h3>
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-y-1">
      {[
        "Honda CG125", "Honda CD70", "Suzuki GD 110S", "Yamaha YBR 125", "Yamaha YBR 125G", "Suzuki GS 150", "Yamaha YB 125Z", "Benelli 302r",
        "Honda CB 150F", "Honda CG 125 Deluxe", "Yamaha YZF R6", "Suzuki GS 150SE", "Suzuki GSX-R600", "Road Prince Wego 150", "Honda Pridor", "Yamaha YZF R1"
      ].map((bike, idx) => (
        <a key={idx} href="#" className="text-blue-600 hover:underline">{bike}</a>
      ))}
    </div>
  </div>
  <div>
    <h3 className="font-semibold text-base mb-2">Top Categories</h3>
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-y-1">
      {[
        "660cc Cars","1000cc Cars","1300cc Cars","Japanese Cars","Cheap Cars","Low Priced Cars","Automatic Cars","Small Cars","Big Cars","Carry Daba","Jeep","Hybrid Cars","Sports Cars","Imported Cars"
      ].map((category, idx) => (
        <a key={idx} href="#" className="text-blue-600 hover:underline">{category}</a>
      ))}
    </div>
  </div>
  <div>
    <h3 className="font-semibold text-base mb-2">Top Auto Parts Categories</h3>
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-y-1">
      {[
        "Tyres & Wheels", "Audio & Vedio Accessories", "Light & Electrical", "Car Care Accessories", "Exterior Parts & Accessories", "Engine & Mechanical Parts", "Brake Parts", "Interior Parts & Accessories",
        "Security Sensors", "Oils & Lubricants", "Tools & Gadgets", "Bike Parts & Accessories", "Bicycle Parts & Accessories", "Other Parts & Accessories"
      ].map((auto, idx) => (
        <a key={idx} href="#" className="text-blue-600 hover:underline">{auto}</a>
      ))}
    </div>
  </div>
  <div>
    <h3 className="font-semibold text-base mb-2">Top Auto Parts Sub-Categories</h3>
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-y-1">
      {[
        "Alloy Wheels", "Bike Parts", "Complete Engines", "Tyres","Car LCD & Vedio Displays", "Helmets", "Woofers", "Seat Covers","Speakers", "Car Seats", "Spoilers & Body Kits", "LED Lights", "Pressure Washers", "Car Door Parts", "Amplifiers", "HID Lights"
      ].map((bike, idx) => (
        <a key={idx} href="#" className="text-blue-600 hover:underline">{bike}</a>
      ))}
    </div>
